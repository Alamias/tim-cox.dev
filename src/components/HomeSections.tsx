        ...
        <div className='site-gutter mx-auto grid max-w-6xl gap-8 py-12 sm:gap-10 sm:py-16 md:grid-cols-[1.2fr_1fr] md:items-center'>
          ...
          >
            ...
            <p className='mt-4 max-w-xl text-base leading-relaxed text-ink-muted'>
              From Station.com-era MMO platforms to modern React/Next.js stacks,
              I focus on performance, shared UI systems, and shipping reliably
      ...
      <section className='site-gutter mx-auto max-w-6xl py-14 sm:py-20'>
        ...
        >
          ...
          <p className='mt-3 max-w-xl text-white/85'>
            Open to Senior Frontend and frontend-focused full-stack roles—remote
            or hybrid within reach of Ontario, California.
          </p>
          <Link
            href='/contact'
