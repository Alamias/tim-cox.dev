  ...
  return (
    <motion.header
      ...
      className={clsx(
        ...
        compact || menuOpen ? "border-line bg-canvas/90" : "border-transparent bg-canvas/70"
      )}
      ...
      <AnimatePresence>
        {menuOpen && (
          <>
            ...
            >
              <nav aria-label="Mobile" className="site-gutter mx-auto flex max-w-6xl flex-col py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
                {links.map((link) => {
                  const active =
                    pathname === link.href || pathname.startsWith(`${link.href}/`);
                  return (
