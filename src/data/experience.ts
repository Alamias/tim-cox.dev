...
export const profile = {
  ...
  tagline:
    "Twenty-plus years building web platforms for games, genetics, and entertainment—React, Next.js, and TypeScript at scale.",
  about: [
...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    stack: ["Angular", "AngularJS", "HTML5", "SASS", "Webpack", "Jekyll", "Git"],
    accent: "#6b4f3a",
  ...
  },
  {
    ...
    stack: ["Java", "JSP", "PHP", "MySQL", "jQuery", "SASS", "Tomcat", "Spring"],
    accent: "#1a4d8c",
...
export function getAdjacent(slug: string) {
  ...
  return {
    ...
    next: index >= 0 && index < experiences.length - 1 ? experiences[index + 1] : null,
  };
}
